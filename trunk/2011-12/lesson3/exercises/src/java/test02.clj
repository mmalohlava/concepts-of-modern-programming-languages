; example from http://en.wikibooks.org/wiki/Clojure_Programming/Examples/Temperature_Converter_GUI
;
...
(let [frame (new JFrame "Celsius Converter")
    ...
    (doto frame 
                ;(.setDefaultCloseOperation (JFrame/EXIT_ON_CLOSE)) ;uncomment
this line to quit app on frame close
