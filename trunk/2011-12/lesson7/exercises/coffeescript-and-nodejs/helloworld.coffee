...
class ItemView extends Backbone.View
    ...
    ### TODO:
    # Put here definition of elements' (span.swap, span.remove) events handlers
    ###
    #events:

    ### TODO:
    #bind model change and remove to method @render resp. @unrender
    ###
    initialize: ->
    
    # Renderes the item. Fat arrow needed for reference to @ (this)
    ### TODO: 
    # Put here swap_html and remove_html definition as <span class="swap">... and 
    # <span class="remove">...
    ###
    render: =>
        swap_html = "swap "
    ...
    swap: ->
        # TODO: Create an object with two hashes and set @model to it
        swapped = {}
