...
console.log('course4.prototype =', course4.prototype);
console.log('course5.constructor =', course5.constructor);
console.log('course5.prototype =', course5.prototype);
...
console.log('simpleObject.toString =', simpleObject.toString);
console.log('simpleObject.prototype =', simpleObject.prototype);
console.log('Course =', Course);
console.log('Course.prototype =', Course.prototype);
console.log('Course.prototype.constructor =', Course.prototype.constructor);
console.log(Course.prototype.constructor == Course);
