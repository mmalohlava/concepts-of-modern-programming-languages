...
Grab the [lecture5.zip](http://code.google.com/p/concepts-of-modern-programming-languages/downloads/detail?name=lecture5.zip&can=2&q=) file to get code examples to work with during the lesson.
